...
<template>
  <div>
    <span
      ...
      @click="$store.themeSettingsStore.isOpenSettings = !$store.themeSettingsStore.isOpenSettings"
    >
      <Icon
        icon="heroicons:cog-6-tooth"
        class="text-slate-50 text-lg animate-spin"
      />
      <span class="hidden md:inline-block ltr:ml-2 rtl:mr-2">Settings</span></span>
